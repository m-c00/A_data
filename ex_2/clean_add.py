...
data_subset1 = data.iloc[268:, [10, 11]]




# Interpolate and clean data
interpolated_col_1 = clean_and_interpolate(data_subset1.iloc[:, 0], 20332, 20832, 100, 500, 500, 'pchip')
interpolated_col_1 = clean_and_interpolate(interpolated_col_1, 17332, 19032, 100, 500, 500, 'rbf')
interpolated_col_1 = clean_and_interpolate(interpolated_col_1, 15300, 15500, 100, 500, 500, 'pchip')
interpolated_col_1 = clean_and_interpolate(interpolated_col_1, 12332, 14332, 100, 500, 500, 'pchip')
...
interpolated_col_1 = clean_and_interpolate(interpolated_col_1, 900, 1600, 200, 300, 200, 'rbf')

interpolated_col_2 = clean_and_interpolate(data_subset1.iloc[:, 1], 20332, 20832, 100, 500, 500, 'pchip')
interpolated_col_2 = clean_and_interpolate(interpolated_col_2, 17332, 19032, 100, 500, 500, 'rbf')
interpolated_col_2 = clean_and_interpolate(interpolated_col_2, 15300, 15500, 100, 500, 500, 'pchip')
interpolated_col_2 = clean_and_interpolate(interpolated_col_2, 12332, 14332, 100, 500, 500, 'pchip')
...
interpolated_col_2 = clean_and_interpolate(interpolated_col_2, 900, 1600, 200, 300, 200, 'rbf')
